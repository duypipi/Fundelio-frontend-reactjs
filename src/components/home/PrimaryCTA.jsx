...
export const PrimaryCTA = ({
  ...
  return (
    <section
      className="pb-14 sm:pb-16 lg:pb-20 bg-gray-50 dark:bg-darker-light transition-colors duration-300"
      role="region"
    ...
    >
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-darker-light/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
