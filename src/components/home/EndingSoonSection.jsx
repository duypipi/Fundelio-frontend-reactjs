                    ...
                    {campaigns.length > 4 && (
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="ending-prev p-2 rounded-sm transition-all duration-200 bg-red-500 text-white hover:bg-red-600 hover:scale-105 disabled:bg-gray-200 dark:disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed disabled:hover:scale-100 shadow-card"
                                aria-label="Previous"
                            >
                            ...
                            <button
                                ...
                                className="ending-next p-2 rounded-sm transition-all duration-200 bg-red-500 text-white hover:bg-red-600 hover:scale-105 disabled:bg-gray-200 dark:disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed disabled:hover:scale-100 shadow-card"
                                aria-label="Next"
                            >
